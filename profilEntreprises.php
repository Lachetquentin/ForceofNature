...
<body>
    ...
    <div class="container my-5 py-5 pe-0 ps-0 borders shadow" style="background:#D1EDD4;">
        <div class="d-flex justify-content-center border-bottom border-dark pb-2">
            <i class="material-icons me-3">work_outline</i>
            <h3>Entreprise : Indify</h3>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col ms-5 d-flex align-items-center">
                ...
                <p class="mb-0">Adresse de l’entreprise : <br> 345 avenue de l’Europe </p>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col ms-5 d-flex align-items-center">
        ...
        <div class="row mt-5">
            ...
            <div class="col ms-5 d-flex align-items-center">
                <i class="material-icons scop mt-0 me-3">house</i>
                <p class="mb-0">Codepostal : <br> 75009 </p>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col ms-5 d-flex align-items-center">

...
if (isset($_GET['addBtn'])) {
    ...
    $confirmpw = isset($_GET['confirmpassword']) ? htmlspecialchars($_GET['confirmpassword']) : "";
    ...
    $zipcode = isset($_GET['zipcode']) ? htmlspecialchars($_GET['zipcode']) : "";
    $idtype = isset($_GET['id_type']) ? htmlspecialchars($_GET['id_type']) : "";
    $idcountry = isset($_GET['id_country']) ? htmlspecialchars($_GET['id_country']) : "";
...
<body>
    ...
    <main>
        ...
        ?>
        <form action="p_inscription.php" method="GET" class="d-flex justify-content-center">

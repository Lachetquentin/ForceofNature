        ...
        <div class="ms-0 cart p-5 borders" style="background: #A9ED98;">
            <div class="row">
                <div class="col d-flex ">
                    <img src="./images/services/service1.png" class="borders shadow" style="width: 170px; height:210px;"></img>
                </div>
            ...
            <div class="row mt-5">
                <div class="col d-flex ">
                    <img src="./images/services/service2.png" class="borders shadow" style="width: 170px; height:210px;"></img>
                </div>
                <div class="col d-grid align-items-center">
                    <p>Titre service</p>
                    <div class="col">

        ...
        <form class="d-flex justify-content-center">
            <div class="form mw-100 m-5 p-4 b-radius shadow">
                <div class="form-group d-flex justify-content-center align-items-center">
                    ...
                    <input type="text" class="form-control shadow-sm m-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nom*">
                    <input type="text" class="form-control shadow-sm m-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Prénom*">
                </div>

        ...
        <form class="d-flex justify-content-center">
            <div class="form mw-100 m-5 p-4 b-radius shadow">
                ...
                <div class="form-group mt-2 d-flex justify-content-center align-items-center">
                    ...
                    <input type="password" class="form-control shadow-sm m-2" id="exampleInputPassword1" placeholder="Mot de passe">
                </div>
                ...
                <div class="d-flex justify-content-center form-group">
                    <p class="mw-100 mt-3 no-spacing">Vous n'avez pas de compte ? <a href="inscription.php"> Inscrivez-vous </a></p>
                </div>
            </div>
        </form>
